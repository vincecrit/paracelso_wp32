"""
CLI interface for `ot.algorithms.SkiOpticalFlowILK` algorithm
...
class SKIOFILK_CLI(BaseCLI):
    ...
    def add_specific_args(self):
        self.parser.add_argument("--radius", help=RADIUS, type=int, default=4)
        self.parser.add_argument("--num_warp", help=NUMWARP, type=int, default=3)
        self.parser.add_argument("--gaussian", help=GAUSSIAN, action="store_true")
